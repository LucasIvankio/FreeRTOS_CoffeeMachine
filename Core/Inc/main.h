...
#define BUTTON_CUP_SIZE_1_Pin GPIO_PIN_0
#define BUTTON_CUP_SIZE_1_GPIO_Port GPIOC
#define BUTTON_CUP_SIZE_1_EXTI_IRQn EXTI0_IRQn
#define BUTTON_CUP_SIZE_2_Pin GPIO_PIN_1
#define BUTTON_CUP_SIZE_2_GPIO_Port GPIOC
#define BUTTON_CUP_SIZE_2_EXTI_IRQn EXTI1_IRQn
#define BUTTON_CUP_SIZE_3_Pin GPIO_PIN_2
#define BUTTON_CUP_SIZE_3_GPIO_Port GPIOC
#define BUTTON_CUP_SIZE_3_EXTI_IRQn EXTI2_IRQn
#define BUTTON_CUP_SIZE_4_Pin GPIO_PIN_3
#define BUTTON_CUP_SIZE_4_GPIO_Port GPIOC
#define BUTTON_CUP_SIZE_4_EXTI_IRQn EXTI3_IRQn
#define LED_ADD_WATER_Pin GPIO_PIN_0
#define LED_ADD_WATER_GPIO_Port GPIOA
#define LED_AUTO_OFF_Pin GPIO_PIN_1
#define LED_AUTO_OFF_GPIO_Port GPIOA
#define ARD_D10_Pin GPIO_PIN_2
#define ARD_D10_GPIO_Port GPIOA
#define LED_CUP_SIZE_2_Pin GPIO_PIN_3
#define LED_CUP_SIZE_2_GPIO_Port GPIOA
...
#define BUTTON_STRONG_BREW_Pin GPIO_PIN_4
#define BUTTON_STRONG_BREW_GPIO_Port GPIOC
#define BUTTON_STRONG_BREW_EXTI_IRQn EXTI4_IRQn
#define WATER_LVL_Pin GPIO_PIN_5
#define WATER_LVL_GPIO_Port GPIOC
#define LED_CUP_SIZE_1_Pin GPIO_PIN_0
#define LED_CUP_SIZE_1_GPIO_Port GPIOB
#define LED_CUP_SIZE_4_Pin GPIO_PIN_1
#define LED_CUP_SIZE_4_GPIO_Port GPIOB
...
#define LED_STRONG_BREW_Pin GPIO_PIN_14
#define LED_STRONG_BREW_GPIO_Port GPIOD
...
#define LED_CUP_SIZE_3_Pin GPIO_PIN_4
#define LED_CUP_SIZE_3_GPIO_Port GPIOB
